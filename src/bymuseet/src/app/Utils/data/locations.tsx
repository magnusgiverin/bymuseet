...
const locations: Location[] = [
  {
    ...
    info: {
      ...
      info2: 'Valget av utsendinger fra amtet til Riksforsamlingen på Eidsvold i 1814  foregikk på Brusve. Brusve nedre har også vært vertskap for kongelig besøk ifølge innberetningen: "Karl Johan bodde der under sit opphold i Trøndelagen 1835."',
  ...
  },
  {
    ...
    description: 'Levanger skole var fylkets første fastskole med oppstart i 1803. Til det såkalte Middelskolebygget i Kirkegata 11 kom skolen i 1878, først som lokale for byens borgerskole, og deretter med klassene fra Levanger folkeskole, senere Levanger barneskole, som ble lagt ned i 2005. Siden 1985 har Skolemuseet holdt til her.\n\nFra 1892 var skolen i mange år eneste øvingsskole for Levanger lærerskole. Det er tatt vare på store mengder undervisningsmateriell opp gjennom årene og i 1985 ble det systematisk registrert og plassert i et klasserom i Middelskolebygget. Rommet er aldri gjort om – det er møblert med trepulter fra ca. 1900 og inneholder gjenstander det knapt finnes make til i Trøndelag. I dette klasserommet får man et godt innblikk i hvordan en byskole ble drevet for 100 år siden.',
    info: {
